...
# assumes predictions are in Face++ format
...
annotationsPath = "/data/faces/Landmarks/300w/annotations/300w_cropped/01_Indoor"
...
#Add unique id for each point in all images
annoDT[,UID := paste0(substr(file_path_sans_ext(firstFile), 1,10), "_", pointID)]
...
if(writeControl){
    #resultsPath = args[3]
    resultsPath = "/data/faces/Landmarks/300w/experiments/Face++/Results_300w_Face++/indoor"
    setwd(resultsPath)
